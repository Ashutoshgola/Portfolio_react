...
const Navbar = ()=>{
    ...
    return(
        <div className='navbar'>
            <div className="navbar-logo"><img src={intro_logo} alt="Logo"/></div>
            <img src={menu_open} onClick={openMenu} alt='' className='nav-mob-open'/>
            <ul ref={menuRef} className='nav-menu'>
                <img nav-mob-close src={menu_close} onClick={closeMenu} alt='' className='nav-mob-close'/>
                ...
                <li><AnchorLink className='anchor-link' offset={50} href='#services'><p onClick={()=>setMenu("services")}>Capabilities</p></AnchorLink>{menu==='services'?<img src={underline}alt =""/>:<></>}</li>
